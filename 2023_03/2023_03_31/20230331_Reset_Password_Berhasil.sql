		...
		<tr>
			<td style="padding: 24px ; background-color: #FFFFFF">
				...
				font-size:14px; line-height: 20px;">Ubah password kamu dengan kombinasi yang belum pernah digunakan.</li>
					<li style="color: rgba(0, 0, 0, 0.96); font-family: DM Sans,sans-serif;
				font-size:14px; line-height: 20px;"><span>Hubungi</span> <span style="font-weight:bold">BSI Call Center</span> <span>di</span> <span style="font-weight:bold">14040</span> <span>atau email ke </span> <a href="mailto:contactu'
	) || TO_CLOB(
		's@bankbsi.co.id" style="font-weight:bold; color: #F2B441;">contactus@bankbsi.co.id</a></li>
				</ol>
				</p>
			</td>
		</tr>
									...
									<span style="float: right; width:100px; text-align: left;">
										<p>
											<a href="https://bankbsi.id/facebook_bsi" target="_blank" >
												<img width="20px" height="20px" src="https://storage.googleapis.com/bsisuperapp2.bankbsi.co.id/assets/em'
	) || TO_CLOB(
		'ail/icon-facebook.png" />
											</a>
...
WHERE TEMPLATE_TYPE = 'EMAIL' AND TEMPLATE_CODE = 'RESET_PASSWORD_SUCCESS';
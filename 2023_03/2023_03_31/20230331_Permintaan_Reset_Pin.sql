...
SET MESSAGE_CONTENT = TO_CLOB('<!DOCTYPE html>
<html lang="en">
	...
	<style>
		:root {
		    ...
		    * {
		    ...
		    .a6S {
		      display: none !imp')||TO_CLOB('ortant;
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #F8F8F8;">
	<center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: #F8F8F8;">
		...
		')||TO_CLOB('	<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
         <tr>
                <td align="left" style="padding: 24px; background-color: #FFFFFF; text-align: left;">
                    <img src="https://storage.googleapis.com/bsisuperapp2.bankbsi.co.id/assets/img_web_bsi/logo.png" width="111px" height="32px" >
                </td>
            </tr>
				<tr>
        ...
        <tr>
			<td style="padding: 8px 20px 2px; background-color: #FFFFFF; font-size: 12px;">
				Assalamualaikum ${nasabah},<br>
				<p>Password akun BSI kamu untuk email ${emailNasabah} telah diubah pada ${resetDate}.</p>
			</td>
        </tr>
		<tr>
			<td style="padding: 24px ; background-color: #FFFFFF">
				...
				font-size:14px; line-height: 20px;">Ubah password kamu dengan kombinasi yang belum pernah digunakan.</li>
					<li style="color: rgba(0, 0, 0, 0.96); font-family: DM Sans,sans-serif;
				font-size:14px; line-height: 20px;"><span>Hubungi</span> <span style="font-weight:bold">BSI Call Center</span> <span>di</span> <span style="font-weight:bold">14040</span> <span>atau email ke </span> <a href="mailto:contactu')||TO_CLOB('s@bankbsi.co.id" style="font-weight:bold; color: #F2B441;">contactus@bankbsi.co.id</a></li>
				</ol>
				</p>
			</td>
		</tr>
									...
									<span style="float: right; width:100px; text-align: left;">
										<p>
											<a href="https://bankbsi.id/facebook_bsi" target="_blank" >
												<img width="20px" height="20px" src="https://storage.googleapis.com/bsisuperapp2.bankbsi.co.id/assets/em')||TO_CLOB('ail/icon-facebook.png" />
											</a>
...
WHERE TEMPLATE_TYPE = 'EMAIL'
    AND MESSAGE_SUBJECT = 'Permintaan Reset PIN';